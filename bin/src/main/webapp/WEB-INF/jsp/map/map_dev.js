...
var afsCctvLayer = new afsCctvLayer({})
afsCctvLayer.getCctvInArea().done(function(){
    var cctvLayer = afsCctvLayer.initLayer();
    cctvLayer.addTo(map)
    dataLayerControl.addOverlay({
        name: "CCTV",
        icon: '<i class="fas fa-cctv"></i>',
        layer: cctvLayer,
        custom: {
            layerType: "cctv" // layer type 설정
        },
    }, "cctv", "cctv");
})
/*E[EHS:2019-06-14 PM0609]=======================================================================*/
